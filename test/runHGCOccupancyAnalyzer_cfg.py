...
process = cms.Process("HGCOcupancyAnalysis")
...
# cmsRun test/runHGCOccupancyAnalyzer_cfg.py tag
...
import os,sys
if(len(sys.argv)<3):
    print '\ncmsRun runHGCOccupancyAnalyzer_cfg.py doFullAnalysis tag first_file step\n'
